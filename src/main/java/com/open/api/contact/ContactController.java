...
public class ContactController {
    ...
    @Operation(summary = "Find Contacts by name", description = "Name search by %name% format", tags = {
            "contact"})
    @ApiResponses(value = {
    ...
    public ResponseEntity<List<Contact>> findAll(
        ...
        return ResponseEntity.of(Optional.of(Arrays.asList(new Contact())));
    }

    @Operation(summary = "Find contact by ID", description = "Returns a single contact", tags = {
            "contact"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "successful operation",
    ...
    public ResponseEntity<Contact> findContactById(
        ...
        return ResponseEntity.of(Optional.of(new Contact()));
    }
    ...
    @Operation(summary = "Update an existing contact's address", description = "", tags = {
            "contact"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "successful operation"),
            @ApiResponse(responseCode = "404", description = "Contact not found")})
